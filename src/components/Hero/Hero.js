    ...
    return (
      <div className="hero-container">
        <div className="w-6/12 mx-auto flex items-center justify-center h-full">
          <div>
            <h3 className="text-4xl text-fuchsia-400 mb-5">Premeum Quality</h3>
            ...
            <button className="rounded-md bg-fuchsia-400 text-white py-3 px-5 font-semibold mr-4">
              REGINTRATION
            </button>
            <button className="rounded-md bg-transparent text-fuchsia-400 border border-fuchsia-400 py-3 px-5 font-semibold">
              ALL COURSES
            </button>
          </div>
        </div>
